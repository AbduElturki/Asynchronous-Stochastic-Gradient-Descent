#Modified code of cifar10_input.py from the cifar10 tutorial of Tensorflow (see https://github.com/tensorflow/models/tree/master/tutorials/image/cifar10)
...
def get_local_data(current_worker_id=0,total_number_of_worker=1):
  examples_per_worker = 60000/total_number_of_worker
